...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    orders: Attribute.Relation<
      ...
      'api::order.order'
    >;
    usedQuickRegister: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::users-permissions.user',
...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    catId: Attribute.UID<'api::category.category', 'name'>;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    deliveryInformation: Attribute.JSON;
    ...
    state: Attribute.Enumeration<
      ['canceled', 'delivered', 'ready', 'unconfirmed', 'confirmed']
    > &
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    priceWithDiscount: Attribute.BigInteger;
